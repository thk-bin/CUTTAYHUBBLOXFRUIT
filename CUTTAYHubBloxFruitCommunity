...
Settings:AddToggle("Auto SetSpawn Point",true,function(value)
    _G.Set = value
end)
...
Settings:AddDropdown("Select Weapon",WeaponList,function(value)
...
FarmMode = "Normal"
Settings:AddDropdown("Select Farm Mode", ListF,function(value)
    FarmMode = value
end)

Settings:AddToggle("Bypass TP",BypassTP,function(Fast)
BypassTP = Fast
end)

    
Settings:AddToggle("Bring Mob",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
_G.BringMode = "Normal"
Settings:AddDropdown("Bring Mob Mode", Bring,function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
Settings:AddToggle("Auto Haki",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
...
Settings:AddDropdown("Fast Attack Delay", AttackList,function(SimpRose)
...
Settings:AddToggle("Remove Hit Sound And Level Up",false,function(Remo)
_G.RemoveHit = Remo
end)
...
Settings:AddToggle("Disabled Damage",false,function(Remo)
...
Settings:AddToggle("Black Screen",false,function(Umm)
...
Settings:AddToggle("White Screen",_G.WhiteScreen,function(value)
...
elseif _G.WhiteScreen == false then
    ...
    Settings:AddToggle("Invisible Monsters",_G.inv,function(value)
    _G.inv = value
    ...
    Settings:AddSeperator("Setting Farm Mode")

    Settings:AddLabel("Distance X Right Vector")
    Settings:AddLabel("Distance Y Up Vector")
    Settings:AddLabel("Distance Z Behind Vector")

    PosY = 35
    Settings:AddSlider("Pos Y Distance Farm ",0,50,35,function(value)
    PosY = value
    end)

    Settings:AddSeperator("Misc Setting Mastery")
    
    _G.Kill_At = 25
    Settings:AddSlider("Kill At %",1,100,25,function(value)
        _G.Kill_At = value
    end)
    
 
    Settings:AddToggle("Skill Z",true,function(value)
        _G.SkillZ = value
    end)
 
    
    Settings:AddToggle("Skill X",true,function(value)
        _G.SkillX = value
    end)
    
    Settings:AddToggle("Skill C",true,function(value)
        _G.SkillC = value
    end)
    
     Settings:AddToggle("Skill V",true,function(value)
        _G.SkillV = value
    end)
--------------------------------------------------------------------------------------------------------
Main:AddSeperator("Farming")
...
Main:AddToggle("Auto Kaitun",false,function(value)
       _G.AutoFarm = value
...
--------------------------------------------------------------------------------------------------------
EventGame:AddSeperator("Rough Sea")
    
    EventGame:AddToggle("Auto Drive Boat", _G.AppleAutoDriveBoat,function(value)
    ...
    EventGame:AddToggle("Auto Farm Terrorshark", _G.AutoTerrorshark,function(value)
         _G.AutoTerrorshark = value
        StopTween( _G.AutoTerrorshark)
    end)
    
    EventGame:AddToggle("Auto Farm Shark",FarmTFully,function(value)
    FarmShark = value
    StopTween(FarmShark)
    end)
    ...
    EventGame:AddToggle("Auto Farm Piranha",_G.farmpiranya,function(value)
    _G.farmpiranya = value
    StopTween(_G.farmpiranya)
    end)
    
    EventGame:AddToggle("Auto Fish Crew Member",_G.Fish_Crew_Member,function(value)
    _G.Fish_Crew_Member = value
    StopTween(_G.Fish_Crew_Member)
    end)
    
    EventGame:AddToggle("Auto Terrorshark Hop", _G.AutoTerrorsharkhop,function(value)
    ...
    EventGame:AddToggle("Auto Raid Ship",_G.KillGhostShip,function(value)
    ...
    EventGame:AddToggle("Auto Ghost Ship",_G.bjirFishBoat,function(value)
...
spawn(function()
    ...
    EventGame:AddToggle("Auto Frozen Dimension",_G.AutoFrozenDimension,function(value)
    _G.AutoFrozenDimension = value
    StopTween(_G.AutoFrozenDimension)
    end)
    
    EventGame:AddSeperator("Kitsune Event")
    
    EventGame:AddToggle("Auto Kitsunen Island",_G.AutoFKitsune,function(value)
...
EventGame:AddToggle("Teleporter Kitsune", false, function(value)
    _G.tpkit = value
    StopTween(_G.tpkit)
end)
...
EventGame:AddToggle("Auto Collect Azure Ember", false, function(value)
    _G.lumlinhhon = value
...
EventGame:AddButton("Teleport Azure Ember",function()
...
EventGame:AddButton("Trade Azure Ember",function()
game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Net"):WaitForChild("RF/KitsuneStatuePray"):InvokeServer()
 end)
--------------------------------------------------------------------------------------------------------
Visual:AddSeperator("ESP MENU")
Visual:AddToggle("ESP Island Kitsune",false,function(value)
        IslandESP = value
...
Visual:AddToggle("ESP Player",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
    Visual:AddToggle("ESP Chest",false,function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    Visual:AddToggle("ESP Fruit",false,function(a)
        DevilFruitESP = a
    ...
    Visual:AddToggle("ESP Real Fruit",RealFruitESP,function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    Visual:AddToggle("ESP Flower",false,function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
Visual:AddToggle("ESP Island",IslandESP,function(value)
        IslandESP = value
        while IslandESP do wait()
            UpdateIslandESP() 
        end
    end)
    Visual:AddToggle("Esp Npc", false, function(nec)
    NpcESP = nec
end)

Visual:AddToggle("Esp Sea Beast", false, function(nec)
    SeaESP = nec
end)


Visual:AddToggle("Esp Mob", false, function(nec)
    MobESP = nec
end)

Visual:AddToggle("Esp Mystic Island", false, function(value)
...
Visual:AddToggle("Esp Advanced Fruit Dealer", false, function(value)
    AfdESP = value
...
Visual:AddToggle("Esp Gear", false, function(value)
    GearESP = value
...
Visual:AddButton('Rain Fruit', function()
...
Visual:AddButton('Instant Level/Beli/EXP', function()
local plr = game:GetService("Players").LocalPlayer
	...
	Visual:AddTextbox("Fake Level",true,function(value)
        game:GetService("Players").LocalPlayer.Data.Level.Value = value
    end)
    
    Visual:AddTextbox("Fake Exp",true,function(value)
        game:GetService("Players").LocalPlayer.Data.Exp.Value = value
    end)
    
    Visual:AddTextbox("Fake Money",true,function(value)
        game:GetService("Players").LocalPlayer.Data.Beli.Value = value
    end)
    
    Visual:AddTextbox("Fake Points",true,function(value)
        game:GetService("Players").LocalPlayer.Data.Points.Value = value
    end)
    
    Visual:AddTextbox("Fake Bounty",true,function(value)
        game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value = value
    end)

Visual:AddSeperator(" Fake Race V4 ")


Visual:AddButton("Mink Fake Transform",function()
...
Visual:AddButton("Fishman Fake Transform",function()
...
Visual:AddButton("Skypeian Fake Transform",function()
...
Visual:AddButton("Ghoul Fake Transform",function()
...
Visual:AddButton("Cyborg Fake Transform",function()
...
Visual:AddButton("Human Fake Transform",function()
...
Visual:AddButton("Fake Mink Dash Animation",function()
 local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
Visual:AddToggle("Show Chat disabled", _G.chat, function(value)
    _G.chat = value
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
  ...
  Visual:AddToggle("Show leaderboard disabled", _G.leaderboard, function(a)
    _G.leaderboard = a
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
    ...
    Visual:AddToggle("Highlight Mode",false,function(value)
        if value == true then
...
Visual:AddToggle("Graphic",false,function(v)
			if v then
	...
	Visual:AddToggle("Xray",false,function(value)
		NoWorld = value
	...
	Visual:AddToggle("Rainbow Haki",false,function(value)
		RainbowHaki = value
	end)

	Visual:AddToggle("Rainbow Yoru",false,function(value)
		RainbowYoru = value
	end)
...
Visual:AddLine()
    ...
    Visual:AddButton("Unlock Buso",function()
...
elseif type(Ability) == 'table' then
   ...
   Visual:AddButton("Unlock Soru",function()
...
elseif type(Ability) == 'table' then
   ...
   Visual:AddButton("Unlock Geppo",function()
...
elseif type(Ability) == 'table' then
   for i,v in next , Ability do
    ...
    Visual:AddButton("Unlock Portal",function()
    ...
    Visual:AddButton("Max Zoom", function()
		while wait() do
			game.Players.LocalPlayer.CameraMaxZoomDistance = 9223372036854718
			end
	end)
	
Visual:AddButton("Buddha Big", function()
local LocalPlayer = game:GetService("Players").LocalPlayer
...
Visual:AddButton("Kaitun Cap", function(value)
    ...
    Visual:AddButton("Invisible",function()
        game:GetService("Players").LocalPlayer.Character.LowerTorso:Destroy()
    end)
    
    Visual:AddButton("Click TP Tool",function()
        local plr = game:GetService("Players").LocalPlayer
...
Visual:AddSeperator("Graphic")

    
    Visual:AddButton("FPS Boost",function()
        pcall(function()
    ...
    Visual:AddButton("Remove Fog (New)",function(qww)
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
end)
    
Visual:AddToggle("Remove Fog",RemoveFog,function(value)
    RemoveFog = value
    ...
    Visual:AddButton("Always Day",function()
    game:GetService("RunService").Heartbeat:wait() do
        game:GetService("Lighting").ClockTime = 12
    end
    end)
    
    Visual:AddToggle("Remove Damage",function()
    ...
    Visual:AddButton("Unlock FPS",function()
        setfpscap(9999999)
    end)
    
    Visual:AddButton("Reduce Cpu", function()
	...
	for i, e in pairs(l:GetChildren()) do
     ...
     Visual:AddButton("Fake Skin MODE™",function()
	 spawn(function()
     pcall(function()
     while true do
     wait(.0)
    ...
    Visual:AddSeperator("Abilities")
    
    Visual:AddToggle("Dodge No Cooldown",false,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    
    Visual:AddToggle("Infinite Energy",false,function(value)
        InfiniteEnergy = value
        originalstam = LocalPlayer.Character.Energy.Value
    end)
    
    Visual:AddToggle("Auto Active Race",_G.AutoAgility,function(value)
    ...
    Visual:AddToggle("Infinite Ability",true,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Visual:AddToggle("Auto Use Awakening",_G.AutoAwakeningRace,function(value)
    ...
    Visual:AddToggle("Infinite Obversation Range",getgenv().InfiniteObRange,function(value)
    ...
    Visual:AddToggle("Infinite Geppo",getgenv().InfGeppo,function(value)
    ...
    Visual:AddToggle("Infinite Soru",getgenv().InfSoru,function(value)
    ...
    Visual:AddToggle("Walk on Water",true,function(value)
        _G.WalkWater = value
    end)
    ...
    Visual:AddToggle("NoClip",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
    ...
    Visual:AddButton("Remove Lava",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
			if v.Name == "Lava" then   
				v:Destroy()
			end
...
----------------------------------------------------------------------------------------------------------------------------------------
Notification.Notify("Notification", "Thank You for Using x2N HUB.", "rbxassetid://10709761889", {
    Duration = 5,       
    Main = {
        Rounding = true,
    }
...
wait(6)
Notification.Notify("Notification", "If You Use Fluxus, x2N HUB Will Optimize Fluxus Well.", "rbxassetid://10709761889", {
    Duration = 10,       
    Main = {
        Rounding = true,
    }
